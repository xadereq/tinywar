...
kasapos = {x=1032, y=948, z=7, stackpos=255}
getkasa = getThingfromPos(kasapos)
winpos = {x=1032, y=949, z=7}
if getkasa.itemid == 2160 and getkasa.type == 1 then
rand = math.random(4)
if rand == 1 or rand == 4 or rand == 3 then
doRemoveItem(getkasa.uid,5)
doSendMagicEffect(kasapos,2)
doPlayerSendTextMessage(cid,22,"Straciles 1 Crystal Coins :(.")
end
if rand == 2 then
doRemoveItem(getkasa.uid,5)
